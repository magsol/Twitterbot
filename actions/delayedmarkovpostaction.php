...
include_once(ACTIONS . 'delayedmarkovpostaction' . DIRECTORY_SEPARATOR . 'markovsecondorder.php');
 ...
 * -useUnmodeledPosts: Use only unmodeled posts in the database to build the markov chain.
...
class DelayedMarkovPostAction extends Action {
  ...
  public function run() {
    ...
    /*** PART 2: now that we have our markov chain built, sample from it to build the post ***/
